...
public:
    ...
    void setupUi(QDialog *LicenseDialog)
    {
        ...
        labelIdSoft = new QLabel(LicenseDialog);
        labelIdSoft->setObjectName("labelIdSoft");

        formLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, labelIdSoft);

        editIdSoft = new QLineEdit(LicenseDialog);
        editIdSoft->setObjectName("editIdSoft");

        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, editIdSoft);
        ...
        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, editKey);
    ...
    void retranslateUi(QDialog *LicenseDialog)
    {
        ...
        labelIdSoft->setText(QCoreApplication::translate("LicenseDialog", "ID \320\237\320\236:", nullptr));
